...
def main():
    ...
    logger.info(f"Loading MNIST + MLP benchmark...")
    model_details, _ = load_benchmark(model="mlp", dataset="mnist", metric="lds")
    ...
    # Initialize the gradient Selective Mask for the entire model
