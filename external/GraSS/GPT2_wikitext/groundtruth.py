...
def main():
    ...
    # train_sampler = SubsetSampler(range(100))
    ...
    train_dataloader = DataLoader(
        train_dataset, collate_fn=default_data_collator, batch_size=1, sampler=train_sampler
    )
